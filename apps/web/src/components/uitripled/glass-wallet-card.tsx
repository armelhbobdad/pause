...
export function GlassWalletCard({
  ...
  return (
    ...
    >
      <Card className="group relative h-56 overflow-hidden rounded-2xl border-border/50 bg-gradient-to-br from-card/80 via-card/40 to-card/20 backdrop-blur-md transition-all duration-300 hover:border-primary/50 hover:shadow-primary/10 hover:shadow-xl">
        ...
        <div className="relative flex h-full flex-col justify-between p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-full bg-secondary/50 px-3 py-1 font-mono text-secondary-foreground text-xs backdrop-blur-sm">
                {address}
              </span>
            </div>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center gap-6 bg-background/60 opacity-0 backdrop-blur-[2px] transition-opacity duration-300 group-hover:opacity-100">
            <motion.button
            ...
            >
              ...
              <span className="font-medium text-foreground text-sm">Send</span>
            </motion.button>
